...
export default function NewsPage() {
  ...
  const isNewsInView = useInView(newsRef, { once: true, margin: "-10%" });
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50">
        ...
        <div className="max-w-5xl mx-auto px-6 relative z-10">
          <div className="text-center">
            ...
            <motion.h1
              ...
              className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-4 text-white leading-tight"
            >
              Berita Terkini
            ...
            <motion.div
              ...
              className="flex flex-wrap items-center justify-center gap-6 text-green-200"
            >
                ...
                >
                  <div className="flex items-center justify-between text-sm">
                    <span className="text-slate-600">
                      Hasil pencarian untuk: <strong className="text-slate-800">&quot;{searchTerm}&quot;</strong>
                    </span>
      ...
      <motion.section
        ref={newsRef}
        initial={{ opacity: 0 }}
        animate={isNewsInView ? { opacity: 1 } : { opacity: 0 }}
        transition={{ duration: 0.8 }}
            ...
            {featuredNews.length > 0 && (
              ...
              {news.length === 0 && !loading && !error && (
                ...
                >
                  ...
                  <p className="text-slate-600">Berita akan ditampilkan di sini setelah dipublikasikan</p>
                </motion.div>
              )}
            </>
          )}
